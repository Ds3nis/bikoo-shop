      ...
      <header class="header">
        <div class="container header__container">
          ...
          <div class="header__btmsearch bottom-search">
            <form class="bottom-search__search" action="#" method="">
          ...
          <div class="swiper mainSwiper">
            ...
            <div class="swiper-wrapper">
              ...
              <div
                ...
                style="background-image: url(../img/Slider-01.png)"
                    >
...
Copyright 2024 <strong>Bikoo</strong> <span>&#10084;</span> All
                Rights Reserved.
              </p>

              <img
                class="copyright__partners"
                src="../img/payment-partner.png"
                alt="partners"
                    />
            </div>
          </div>
